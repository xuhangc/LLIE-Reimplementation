'''
“LMT-GP: Combined Latent Mean-Teacher and Gaussian Process for Semi-supervised Low-light Image Enhancement” (ECCV 2024)
'''
...
class LMTGP(nn.Module):
    def __init__(self, num_res=8):
        super(LMTGP, self).__init__()
